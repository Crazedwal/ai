...
11. [Personalization System](#11-personalization-system)
...
All wireframes use ASCII art. They represent layout and structure only — not final visual design. Actual design follows the color and typography rules defined in each section.

Legend:
```
[ Button ]     = clickable button
[ input____]   = text input field
...
### 6.2 Main App — Chat View

```
┌──────────────────────────────────────────────────────────────────────┐
│ ⚠ Guest mode — chats won't be saved.  [ Sign in ]                   │  ← guest banner
├────────────────────┬─────────────────────────────────────────────────┤
│  SIDEBAR           │  CHAT AREA                                      │
│  260px             │                                                  │
│                    │  ┌──────────────────────────────────────────┐   │
│  ◆ AppName         │  │ ☰  My Conversation Title    [Sonnet] ☀  │   │  ← header
│                    │  └──────────────────────────────────────────┘   │
│  [ + New Chat ]    │                                                  │
│                    │                                                  │
...
│  │ ● Chat Title │  │    ─────────────────────────── 10:02 AM        │
│  │   2h ago     │  │                                                  │
│  │  Chat Two    │  │                          Your message here      │
│  │   Yesterday  │  │                          ─────────── 10:03 AM  │
│  │  Old Chat    │  │                                                  │
│  │   Mon        │  │    Here is my response with **markdown**        │
│  └──────────────┘  │    and `inline code` and a list:               │
│                    │    • Item one                                    │
│  ◎ 47 tokens       │    • Item two                                    │
│                    │    ────────────────────────── 10:03 AM          │
│  [▾ Free Model   ] │                                                  │
│  [ 🎰 Plinko     ] │    ● ● ●   ← typing indicator                  │
│  [ ★ Quests     ] │                                                  │
│  [ + Buy Tokens  ] │                                                  │
│                    │  ┌──────────────────────────────────────────┐   │
│  ────────────────  │  │ Type a message...                        │   │
...
### 6.3 New Chat — Empty State with Starter Prompts
...
│                    │                                                  │
│                    │   ┌─────────────────┐  ┌─────────────────┐     │
│                    │   │ Explain a topic │  │  Help me write  │     │
│                    │   │ I'm curious     │  │  something      │     │
│                    │   │ about           │  │                 │     │
│                    │   └─────────────────┘  └─────────────────┘     │
│                    │                                                  │
│                    │   ┌─────────────────┐  ┌─────────────────┐     │
│                    │   │ Debug my code   │  │  Brainstorm     │     │
│                    │   │                 │  │  ideas with me  │     │
│                    │   │                 │  │                 │     │
│                    │   └─────────────────┘  └─────────────────┘     │
│                    │                                                  │
...
### 6.4 Model Selector — Dropdown Open

```
│  [▾ Free Model   ]  ← click opens dropdown below
│  ┌──────────────────────────────┐
│  │  FREE                        │
│  │  ● Nemotron 3 Nano    0 tkn  │  ← active
│  │    Llama 3.1 8B       0 tkn  │
│  │    Mistral 7B         0 tkn  │
│  │                              │
│  │  PREMIUM                     │
│  │    GPT-4o            10 tkn  │
│  │    Claude Sonnet     15 tkn  │
│  │    Gemini Pro         8 tkn  │
│  └──────────────────────────────┘
```
...
### 6.5 Profile Setup Modal — Screen 1 (Choose Path)
...
│   ┌──────────────────────┐  ┌──────────────────────┐    │
│   │                      │  │                      │    │
│   │   ⚡ Quick Setup     │  │   📋 Detailed Setup  │    │
│   │    ~1 minute         │  │    ~3 minutes        │    │
│   │                      │  │                      │    │
│   │  Name + style only   │  │  Full profile with   │    │
│   │                      │  │  persona & prefs     │    │
│   │   [ Choose Quick ]   │  │  [ Choose Detailed ] │    │
│   │                      │  │                      │    │
│   └──────────────────────┘  └──────────────────────┘    │
│                                                          │
│                    Skip for now →                        │
...
### 6.6 Profile Setup Modal — Detailed Step 2/3
...
│           How do you work?                              │
│                                                          │
│   Main use cases (select all that apply)                 │
│   [x] Coding      [x] Writing    [ ] Research            │
│   [ ] Learning    [ ] Brainstorm [ ] Other               │
│                                                          │
│   Preferred response style                               │
│   (o) Concise   ( ) Balanced   ( ) Detailed             │
│                                                          │
│   Preferred tone                                         │
│   ( ) Formal    (o) Casual     ( ) Friendly             │
│                                                          │
│                                                          │
│            [ ← Back ]          [ Next → ]               │
└──────────────────────────────────────────────────────────┘
...
│   Who I am                                               │
│   ┌──────────────────────────────────────────────────┐  │
│   │ I'm a senior backend engineer who works mostly   │  │
│   │ in Python and Go. I have 8 years of experience.  │  │
│   │                                                  │  │
│   └──────────────────────────────────────────────────┘  │
│                                                          │
│   What frustrates me                                     │
│   ┌──────────────────────────────────────────────────┐  │
│   │ Overly verbose answers, unnecessary caveats,     │  │
│   │ explaining things I already know.                │  │
│   └──────────────────────────────────────────────────┘  │
│                                                          │
│   What I'm comfortable with                              │
│   ┌──────────────────────────────────────────────────┐  │
│   │ Technical jargon, blunt feedback, code-heavy     │  │
│   │ answers without hand-holding.                    │  │
│   └──────────────────────────────────────────────────┘  │
│                                                          │
│   KCD Rules                                              │
│   KEEP                                                   │
│   [Always show working code ×]  [Be specific ×]         │
│   [ + Add keep rule _________ ]                          │
│                                                          │
│   CHANGE                                                 │
│   [Make responses shorter ×]                             │
│   [ + Add change rule _______ ]                          │
│                                                          │
│   DELETE                                                 │
│   [Stop adding "I hope this helps" ×]                    │
│   [ + Add delete rule _______ ]                          │
│                                                          │
│                              Reset to blank →            │
└──────────────────────────────────────────────────────────┘
```
...
│  │       · · · · · · · · · · · · · · · · ·                │  │
│  │  ┌──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┐   │  │
│  │  │5C│2C│5x│3x│0 │0 │1x│1x│1x│1x│0 │0 │3x│5x│20│5C│   │  │  ← slots
│  │  └──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┘   │  │
│  └────────────────────────────────────────────────────────┘  │
│                                                              │
│   Bet size                                                   │
│   [ 5 balls  ]  [ 10 balls ]  [●25 balls]  [ 50 balls ]    │
│   (5 tokens)    (10 tokens)   (25 tokens)   (50 tokens)      │
│                                                              │
│   Cost: 25 tokens                                            │
│   [ Drop Balls ]                                             │
│                                                              │
│   Last round: Spent 25 · Won 35 · Net +10 ✓                │
└──────────────────────────────────────────────────────────────┘
```
...
```
┌──────────────────────────────────────────────────────────┐
│  ✕  Active Quests              Resets in: 14:23          │
│                                                          │
│  ┌────────────────────────────────────────────────────┐  │
│  │ 💬 Chat Champion                        +15 tokens │  │
│  │ Send 10 messages                                   │  │
│  │ ▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░░░  7 / 10                    │  │
│  └────────────────────────────────────────────────────┘  │
│                                                          │
│  ┌────────────────────────────────────────────────────┐  │
│  │ 🎰 High Roller                          +20 tokens │  │
│  │ Drop 50 balls in Plinko                            │  │
│  │ ▓▓▓▓▓▓░░░░░░░░░░░░░░░░  20 / 50                  │  │
│  └────────────────────────────────────────────────────┘  │
│                                                          │
│  ┌────────────────────────────────────────────────────┐  │
│  │ ✓ New Conversations                     +10 tokens │  │
│  │ Create 3 new chats               ✓ COMPLETE        │  │
│  │ ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓  3 / 3                    │  │
│  └────────────────────────────────────────────────────┘  │
│                                                          │
│  ┌────────────────────────────────────────────────────┐  │
│  │ 💰 Token Peak                           +30 tokens │  │
│  │ Reach a peak balance of 100 tokens                 │  │
│  │ ▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░░  47 / 100                 │  │
│  └────────────────────────────────────────────────────┘  │
│                                                          │
│              Quests reset in 14:23                       │
└──────────────────────────────────────────────────────────┘
```

---

### 6.10 AFK Check Modal
...
### 6.11 Token Purchase Modal — Step 1 (Pack Selection)
...
│   │   Starter      │ │   Popular      │ │   Pro      │  │
│   │                │ │                │ │            │  │
│   │   100 tokens   │ │   500 tokens   │ │ 1000 tokens│  │
│   │                │ │                │ │            │  │
│   │    $0.99       │ │    $3.99       │ │   $6.99    │  │
│   │                │ │                │ │            │  │
...
│   └────────────────┘ └────────────────┘ └────────────┘  │
│                                                          │
│   ⚠ Payment processing coming soon — not yet active.   │
└──────────────────────────────────────────────────────────┘
```

---

### 6.12 Token Purchase Modal — Step 2 (Checkout)

```
┌──────────────────────────────────────────────────────────┐
│  ✕  Checkout                           ← Back to packs  │
│                                                          │
│  ┌──────────────────────────────┐ ┌──────────────────┐  │
│  │ [Card] [PayPal] [ApplePay]   │ │  Order Summary   │  │
│  │ [GooglePay] [Bank]           │ │                  │  │
│  │──────────────────────────────│ │  Popular Pack    │  │
│  │ Card Number                  │ │  500 tokens      │  │
│  │ [ 1234 5678 9012 3456 ____] │ │                  │  │
│  │                              │ │  $3.99           │  │
│  │ Expiry          CVV          │ │                  │  │
│  │ [ MM/YY ____]  [ ___ ]      │ │                  │  │
│  │                              │ │                  │  │
│  │ Name on card                 │ │ [Complete Purch] │  │
...
│  ─────────────────────────────────────────               │
│  [ Search entries _________________________________ ]    │
│                                                          │
│  v1.7.0  —  2026-04-28                                   │
│  • Added quest system with 30-minute rotation            │
│  • Added 20+ quest templates across 3 categories         │
│  • Quest progress persisted in localStorage              │
│                                                          │
│  v1.6.0  —  2026-04-14                                   │
│  • Rebuilt Plinko with canvas physics engine             │
│  • Added ball betting (5/10/25/50)                       │
│  • Plinko stats now feed quest system                    │
│                                                          │
│  v1.5.0  —  2026-04-01                                   │
│  • Added token economy (balance, spend, earn)            │
│  • Payment modal UI (not yet connected)                  │
│                                                          │
│  v1.4.0  —  2026-03-18                                   │
│  • User constraints modal                                │
│  • KCD system injected into system message               │
│  • Profile setup flow (quick and detailed)               │
│                                                          │
│  v1.0.0  —  2026-02-01                                   │
│  • Initial release — basic AI chat with Firebase auth    │
└──────────────────────────────────────────────────────────┘
```

---

### 6.14 Stock Market — Market Overview

```
┌──────────────────────────────────────────────────────────────────────────┐
│  ← Back to Chat   Market Overview   Screener   Watchlist   Alerts  ● Open│
├──────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│  ┌────────────────┐ ┌────────────────┐ ┌────────────────┐ ┌──────────┐ │
│  │ S&P 500        │ │ NASDAQ         │ │ DOW JONES      │ │ RUSSELL  │ │
│  │ 5,421.03       │ │ 17,032.44      │ │ 39,872.10      │ │ 2,014.32 │ │
│  │ +18.22  +0.34% │ │ +83.41  +0.49% │ │ -42.18  -0.11% │ │ +5.21    │ │
│  └────────────────┘ └────────────────┘ └────────────────┘ └──────────┘ │
│                                                                          │
│  ┌──────────────────────┐ ┌──────────────────────┐ ┌──────────────────┐ │
│  │ TOP GAINERS          │ │ TOP LOSERS           │ │ MOST ACTIVE      │ │
│  │ #  Ticker  %Chg  Vol │ │ #  Ticker  %Chg  Vol │ │ #  Ticker   Vol  │ │
│  │ 1  NVDA  +8.2%  142M │ │ 1  INTC  -5.1%   88M │ │ 1  TSLA   312M  │ │
│  │ 2  META  +4.7%   93M │ │ 2  BA    -3.8%   44M │ │ 2  AAPL   198M  │ │
│  │ 3  TSLA  +3.9%  312M │ │ 3  PFE   -3.2%   67M │ │ 3  NVDA   142M  │ │
│  │ 4  AMD   +3.1%   88M │ │ 4  XOM   -2.9%   55M │ │ 4  AMD     88M  │ │
│  │ 5  AMZN  +2.8%   74M │ │ 5  KO    -2.1%   32M │ │ 5  SPY     81M  │ │
│  └──────────────────────┘ └──────────────────────┘ └──────────────────┘ │
│                                                                          │
│  SECTOR PERFORMANCE                                                      │
│  Technology           +1.2%  ▓▓▓▓▓▓▓▓▓▓▓▓                             │
│  Communication Svcs   +0.8%  ▓▓▓▓▓▓▓▓                                  │
│  Consumer Disc        +0.4%  ▓▓▓▓                                       │
│  Industrials          +0.1%  ▓                                           │
...
│                                                                          │
│  MARKET NEWS                                                             │
│  Fed signals no rate cut until Q4, markets react mixed      Reuters  2m  │
│  NVIDIA announces new AI chip series, shares surge 8%       Bloomberg 14m │
│  Apple reports record services revenue in Q2                CNBC     31m  │
└──────────────────────────────────────────────────────────────────────────┘
```
...
│  ← Back to Chat   Market Overview   Screener   Watchlist   Alerts  ● Open│
├───────────────────────┬──────────────────────────────────────────────────┤
│  FILTERS              │  [ Search ticker or company __________________ ] │
│                       │                                                  │
│  Exchange             │  Showing 8,432 stocks  ▼ Market Cap              │
│  [x] NYSE             │                                                  │
│  [x] NASDAQ           │  #   Ticker  Company            Price   %Chg   Vol    MCap     Sector     │
│  [x] AMEX             │  ─────────────────────────────────────────────────────────────────────  │
│                       │  1   AAPL    Apple Inc.         $189.42  +0.3%  198M   $2.94T  Technology │
│  Sector               │  2   MSFT    Microsoft Corp     $415.21  +0.8%   87M   $3.08T  Technology │
│  [▾ All Sectors    ]  │  3   NVDA    NVIDIA Corp        $875.33  +8.2%  142M   $2.15T  Technology │
│                       │  4   GOOGL   Alphabet Inc       $174.12  -0.2%   64M   $2.18T  Comm Svcs  │
│  Market Cap           │  5   AMZN    Amazon.com         $183.44  +2.8%   74M   $1.91T  Cons Disc  │
│  [All][Mega][Large]   │  6   META    Meta Platforms     $491.22  +4.7%   93M   $1.25T  Comm Svcs  │
│  [Mid][Small][Micro]  │  7   BRK.B   Berkshire Hath     $398.01  -0.1%   18M   $876B   Financials │
│                       │  8   LLY     Eli Lilly          $792.44  +1.2%   22M   $753B   Health Care│
│  Price Range          │  9   JPM     JPMorgan Chase     $197.33  +0.5%   41M   $568B   Financials │
│  Min [$______]        │  10  TSLA    Tesla Inc          $177.82  +3.9%  312M   $567B   Cons Disc  │
│  Max [$______]        │  ...                                                                      │
│                       │  ← Prev   Page 1 of 169   Next →                │
│  % Change             │                                                  │
│  Min [%_____]         │                                                  │
│  Max [%_____]         │                                                  │
│                       │                                                  │
...
│  Apple Inc.                                                              │
│  $189.42   +0.58  +0.31%                              ● Market Open      │
│                                                                          │
│  ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐ ┌────────────┐ │
│  │Mkt Cap │ │  P/E   │ │  EPS   │ │52W Hi  │ │52W Lo  │ │ Avg Vol    │ │
│  │$2.94T  │ │ 28.41  │ │ $6.43  │ │$199.62 │ │$164.08 │ │  64.3M     │ │
│  └────────┘ └────────┘ └────────┘ └────────┘ └────────┘ └────────────┘ │
│  ┌────────┐ ┌────────┐                                                   │
│  │Div Yld │ │  Beta  │                                                   │
│  │ 0.51%  │ │  1.24  │                                                   │
│  └────────┘ └────────┘                                                   │
│                                                                          │
│  [ 1D ] [ 5D ] [ 1M ] [ 3M ] [ 6M ] [ 1Y ] [ 5Y ]   [ Line ] [Candle]  │
│                                                                          │
│  $200 ┤                                                                  │
│  $195 ┤                        ╭────╮                                    │
│  $190 ┤           ╭───────────╯    ╰──────────────────────╮             │
...
│  Website: apple.com  │  Employees: 150,000  │  HQ: Cupertino, CA        │
│                                                                          │
│  NEWS                                                                    │
│  Apple reports record services revenue in Q2                 CNBC   31m  │
│  Analyst raises AAPL price target to $220 amid AI momentum  Barron's 2h  │
│  iPhone 17 supply chain ramp begins in Vietnam              Reuters  4h  │
│                                              [ Load more ]              │
└──────────────────────────────────────────────────────────────────────────┘
```
...
│  MY WATCHLIST                                                            │
│                                                                          │
│  Ticker  Company            Price    %Chg    Volume    Mkt Cap      ✕   │
│  ─────────────────────────────────────────────────────────────────────  │
│  AAPL    Apple Inc.         $189.42  +0.31%   198M     $2.94T       🗑  │
│  MSFT    Microsoft Corp     $415.21  +0.82%    87M     $3.08T       🗑  │
│  NVDA    NVIDIA Corp        $875.33  +8.21%   142M     $2.15T       🗑  │
│  TSLA    Tesla Inc          $177.82  +3.91%   312M      $567B       🗑  │
│                                                                          │
│  Last updated: 10:34 AM  (refreshes every 60s)                          │
│                                                                          │
└──────────────────────────────────────────────────────────────────────────┘
```
...
│                                                                          │
│  ┌── ALERT TRIGGERED ─────────────────────────────────────────────── ✕ ┐│
│  │  NVDA crossed above $800.00 — Current price: $875.33               ││
│  └────────────────────────────────────────────────────────────────────┘│
│                                                                          │
│  ADD ALERT                                                               │
│  Ticker  [NVDA__________▾]   Direction  (o) Above  ( ) Below            │
│  Target Price  [$____________]                                           │
│  [ Add Alert ]                                                           │
│                                                                          │
│  MY ALERTS                                                               │
│                                                                          │
│  Ticker  Company       Direction  Target    Current   Status      ✕     │
│  ─────────────────────────────────────────────────────────────────────  │
│  NVDA    NVIDIA        Above      $800.00   $875.33   ✓ Triggered  🗑   │
│  AAPL    Apple         Below      $170.00   $189.42   ○ Active     🗑   │
│  TSLA    Tesla         Above      $200.00   $177.82   ○ Active     🗑   │
│                                                                          │
└──────────────────────────────────────────────────────────────────────────┘
```
...
### 6.19 Mobile Layout — Sidebar Overlay

```
┌──────────────────────────────────┐
│ ☰  My Chat Title      [Sonnet] ☀│  ← header with hamburger
├──────────────────────────────────┤
│                                  │
...
### 6.20 Mobile Layout — Stock Market Nav

```
┌──────────────────────────────────┐
│ ← Chat  MARKET DATA        ● Open│
├──────────────────────────────────┤
│ Overview │ Screener │ Watch │ ⋯  │  ← tabs, ⋯ = more dropdown
├──────────────────────────────────┤
│ S&P 500    5,421  +0.34%         │
│ NASDAQ    17,032  +0.49%         │
│ DOW       39,872  -0.11%         │
...
│ ─────────────────────────────── │
│ TOP GAINERS                      │
│ NVDA  +8.21%  $875.33   142M    │
│ META  +4.71%  $491.22    93M    │
│ TSLA  +3.91%  $177.82   312M    │
│ ─────────────────────────────── │
│ MARKET NEWS                      │
│ Fed signals no rate cut until Q4 │
